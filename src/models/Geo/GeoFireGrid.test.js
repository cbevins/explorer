...
test('2: FireGrid.setUnburnableCol(), setUnburnableRow(), isUnburnableColRow()', () => {
  ...
  console.log(gf.toString('Pre-Fire with Unburnable Col and Row'))
})
